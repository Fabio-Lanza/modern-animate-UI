  ...
  return (
    <div ref={ref} className="relative">
      <div className="sticky top-20 left-0 mt-20 text-center text-7xl z-50 overflow-hidden">
        ...
        <motion.div style={{scaleX}} className="progressBar w-[97%] ml-6 h-1 bg-gray-300 mt-5 rounded-full"></motion.div>
      </div>
      {projects.map((item: { id: number; title: string; img: string; desc: string },
          index: number
        ) => (
